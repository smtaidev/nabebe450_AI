...
async def lifespan(app: FastAPI):
    # Startup
    logger.info("Starting EmotiCare API...")
    try:
        settings.validate()
        ...
        logger.info("EmotiCare API started successfully")
    ...
    # Shutdown
    logger.info("Shutting down EmotiCare API...")

# Create FastAPI app
app = FastAPI(
    title="EmotiCare API",
    version="1.0.0",
    description="AI-powered healthcare API with 4 essential endpoints",
    lifespan=lifespan
)
